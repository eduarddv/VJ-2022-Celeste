...
void Info::init(int screenWidth, int screenHeight)
{
	this->screenWidth = screenWidth;
	this->screenHeight = screenHeight;
	initShaders();
	prepareArrays(glm::vec2(0, 0), texProgram);
	infoTexture.loadFromFile("images/Info.png", TEXTURE_PIXEL_FORMAT_RGB);
	infoTexture.setMinFilter(GL_NEAREST);
	infoTexture.setMagFilter(GL_NEAREST);
...
void Info::prepareArrays(const glm::vec2& minCoords, ShaderProgram& program)
{
